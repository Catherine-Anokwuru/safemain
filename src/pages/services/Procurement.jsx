  ...
  return (
    <section className="services">
      ...
      <div className="serve-container">
        ...
        <p>
          Our team of experienced procurement professionals has the expertise and industry knowledge to manage the entire procurement process, from sourcing and procurement to logistics and delivery.
          We work closely with our clients to understand their specific needs and requirements, and we use our extensive network of suppliers and vendors to ensure that they receive the best products
          ...
          of quality. We also provide comprehensive logistics and transportation services to ensure that our clients receive their products and services in the most efficient and cost-effective manner
          possible. Our commitment to quality, reliability, and customer satisfaction has made us a trusted procurement partner to many companies in the oil and gas industry
        </p>
      </div>
    </section>
  );
